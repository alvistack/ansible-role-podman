...
if [ -x "$(command -v yum)" ]; then
    ...
    curl -skL -O https://releases.hashicorp.com/vagrant/2.2.16/vagrant_2.2.16_x86_64.rpm
    yum localinstall vagrant_2.2.16_x86_64.rpm
    rm -rf vagrant_2.2.16_*
fi
...
if [ -x "$(command -v zypper)" ]; then
    ...
    curl -skL -O https://releases.hashicorp.com/vagrant/2.2.16/vagrant_2.2.16_x86_64.rpm
    zypper install vagrant_2.2.16_x86_64.rpm
    rm -rf vagrant_2.2.16_*
fi
